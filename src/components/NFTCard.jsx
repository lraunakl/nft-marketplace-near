  ...
  return (
    ...
    >
      ...
      <CardContent style={{textAlign: "left"}}>
        ...
        <div style={{display:"flex",fontSize: 10, marginTop: 16}}>Owned by <span style={{padding: "2px 8px", background: "#e3f2fd", color:"#d32f2ff0", marginLeft: 8, borderRadius: 12}}>{accounts && accounts[0] == nftData?.ownerAddress ? "You" : processHash(nftData?.ownerAddress)}</span></div>
      </CardContent>
    </Card>
  )
}
